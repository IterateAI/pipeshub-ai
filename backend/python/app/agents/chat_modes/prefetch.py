...
class PrefetchResult:
    ...
    applying this onto `AgentContext.tool_state` and for setting
    `context.internal_search_attempted = True` (the two effects live
    together in one place instead of split between a producer and its
    caller, which is what made the pre-implementation-review version of
    this function hard to reason about)."""
