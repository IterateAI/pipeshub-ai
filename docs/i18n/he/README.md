...
- 🔌 **מחברים ארגוניים:** יותר מ-30 מחברים עם אינדוקס בזמן אמת ומתוזמן, מוכנים לשימוש מיד.
...
| Markdown | קובצי ‎.md |
| HTML | דפי אינטרנט |
| Text | קובצי טקסט רגיל |
| Google Docs, Sheets, Slides | פורמטים של Google Workspace |
| תמונות | PNG, JPG וכו' |
| שמע | קובצי שמע |
| וידאו | קובצי וידאו |
...
| טכנולוגיה | תיאור |
|-----------|-------------|
| Next.js | ממשק App Router (React מעובד בצד הלקוח) |
| TypeScript | על-קבוצה של JavaScript עם טיפוסים חזקים |
| Radix UI Themes | רכיבי יסוד נגישים ועיצוב |
| Zod | אימות וניתוח של סכֵמות |
| React Hook Form | ניהול גמיש של מצב טפסים |
...
| Redis | מטמון (Caching) |
| Redis / etcd3 | מאגר תצורה מבוזר מסוג מפתח-ערך |
| Celery | מערכת מבוזרת לתורי משימות |
| Docling | ערכת כלים לניתוח וחילוץ מסמכים |
| PyMuPDF | ספרייה לעיבוד PDF |
...
ל-PipesHub יש יותר מ-30 מחברים ארגוניים עם אינדוקס בזמן אמת ומתוזמן. הוא תומך בפורמטים של קבצים כגון PDF, Docx, XLSX, PPTX, CSV, Markdown, HTML, Google Docs/Sheets/Slides, תמונות, שמע ווידאו.
